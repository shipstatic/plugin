---
name: using-ship
description: Use when the user wants to deploy a website, upload static files, manage deployments, set up domains, or publish static files to shipstatic.com via the ship CLI.
---
